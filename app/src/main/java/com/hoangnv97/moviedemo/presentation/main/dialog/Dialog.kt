    ...
    companion object {
        ...
        fun createReviewAlertDialog(
            ...
            return Builder()
                ...
                .message("Please cooperate evaluation to become a better service.")
...
//    }
    ...
    private fun createIconHeader(title: String?): TextView {
        val icon = ResourcesCompat.getDrawable(
            resources, R.drawable.ic_launcher_foreground, null
        ).apply {
            this!!.setBounds(0, 10, 220, 220)
        }
